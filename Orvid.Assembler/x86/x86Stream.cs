...
namespace Orvid.Assembler.x86
{
	public sealed class x86Stream : AssemblerStream
	{
		...
		public void WriteAddressLiteral(uint lit)
		{
			if (lit + BaseAddress < lit)
				throw new Exception("The address overflowed! Consider using a lower base address.");
			WriteImm32(lit + BaseAddress);
		}
