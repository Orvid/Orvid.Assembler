...
namespace Orvid.Assembler.x86.IstructionGen
{
	...
	public static class StaticTypeReferences
	{
		...
		#region Types
		public static readonly CodeTypeReference x86AssemblySyntax = new CodeTypeReference("x86AssemblySyntax");
		public static readonly CodeTypeReferenceExpression x86AssemblySyntaxExpression = new CodeTypeReferenceExpression(x86AssemblySyntax);
